...
from custom_components.melcloud_custom.sensor import ATW_ZONE_SENSORS, AtwZoneSensor


@pytest.fixture
def mock_device():
    """Mock MELCloud device."""
    with patch("custom_components.melcloud_custom.MelCloudDevice") as mock:
        mock.name = "name"
